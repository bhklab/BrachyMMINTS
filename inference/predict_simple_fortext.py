...
from nnunet.inference.predict_fortext import predict_from_folder
...
def main():
    ...
    input_folder = '/cluster/projects/radiomics/InternalDatasets/procdata/Pelvis/PMCC_Gyn_Autosegmentation/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task072_gyn/imagesTs-FOR-TEST'
    output_folder = '/cluster/projects/radiomics/InternalDatasets/procdata/Pelvis/PMCC_Gyn_Autosegmentation/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task072_gyn/infersTs/CA_siglip/CA_siglip_v3'
    part_id = 0
    num_parts = 1
    model = '3d_fullres'
    folds = [0]
    ...
    mode = 'normal'
    all_in_gpu = 'None'
    trainer_class_name = 'nnUNetTrainerV2_CA_siglip_v3'
    ...
    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        ...
                        overwrite_existing=overwrite_existing, mode=mode, overwrite_all_in_gpu=all_in_gpu,
                        mixed_precision=not False,
                        step_size=step_size, checkpoint_name='model_final_checkpoint') # model_final_checkpoint or model_best
